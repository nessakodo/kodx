...
export default function LabsPage() {
  ...
  // Filter labs based on search query and difficulty filter
      ...
      <main className="container mx-auto py-12 px-4">
        <div className="mb-8">
          ...
          <p className="text-center text-gray-400 max-w-3xl mx-auto mb-8">
            Interactive modules with guided learning, quizzes, and hands-on challenges to build practical skills
            in cybersecurity, privacy, and secure development.
          </p>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-16 bg-[#1e2535]/25 backdrop-blur-md border border-[#9ecfff]/10 rounded-xl">
            <h3 className="text-xl font-orbitron mb-2">No Labs Found</h3>
